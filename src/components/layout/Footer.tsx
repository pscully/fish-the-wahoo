    ...
    <footer className="bg-nautical-dark border-t border-white/5 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          {/* Brand */}
          <div>
            <Link to="/" className="inline-block mb-6" aria-label="Fish The Wahoo — Charleston Fishing Charters">
              <img
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="text-slate-500 text-xs pt-2 leading-relaxed">
                ...
                your captain will send specific directions once your trip is confirmed.
              </li>
            </ul>
          </div>
